...
namespace maednCls.Game
{
    public class SetUp
    {
        ...
        public SetUp()
        {
            ...
            Player zero = new Player(false, 1, "DAE504", 0, toolBelt);
            Player one = new Player(false, 2, "28B463", 10, toolBelt);
            Player two = new Player(true, 3, "E74C3C", 20, toolBelt);
            Player three = new Player(false, 4, "3498DB",  30, toolBelt);
            
            players.Add(zero); players.Add(one); players.Add(two); players.Add(three);

            allMeeples.Add(new Meeple(zero, "11", new HomeSquare(2, 3, "H1"), 0, "H1", toolBelt));
            ...
            allMeeples.Add(new Meeple(one, "21", new HomeSquare(2, 15, "H2"), 0, "H2", toolBelt));
            ...
            allMeeples.Add(new Meeple(two, "31", new HomeSquare(16, 15, "H3"), 23, "H3", toolBelt, 23));
            allMeeples.Add(new Meeple(two, "32", new HomeSquare(16, 17, "H3"), 20, "H3", toolBelt, 20));
            ...
            allMeeples.Add(new Meeple(three, "41", new HomeSquare(16, 3, "H4"), 0, "H4", toolBelt));
